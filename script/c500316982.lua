...
function c500316982.mfilter(c,xyzc)
	return c:IsFaceup() and not c:IsType(TYPE_XYZ) and  c:GetLevel()==6 and c:IsCanBeXyzMaterial(xyzc) and c:IsSetCard(0x285a) or c:IsRace(RACE_WINDBEAST) 
end
...
function c500316982.filter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x285a) and c:IsAbleToDeck()
end
