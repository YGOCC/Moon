...
function c240100230.initial_effect(c)
	...
	e0:SetOperation(c240100230.activate)
	c:RegisterEffect(e0)
	local e4=Effect.CreateEffect(c)
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
	e4:SetCode(EVENT_BE_BATTLE_TARGET)
	e4:SetRange(LOCATION_SZONE)
	e4:SetCondition(c240100230.discon)
	e4:SetOperation(c240100230.disop)
	c:RegisterEffect(e4)
end
function c240100230.filter(c)
...
function c240100230.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c240100230.disop(e,tp,eg,ep,ev,re,r,rp)
