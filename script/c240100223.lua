...
function c240100223.initial_effect(c)
	...
	e1:SetCountLimit(1,240100223+EFFECT_COUNT_CODE_OATH)
	e1:SetCondition(c240100223.condition)
	e1:SetOperation(c240100223.activate)
	c:RegisterEffect(e1)
	...
	e2:SetTarget(c240100223.target)
	e2:SetOperation(c240100223.operation)
	c:RegisterEffect(e2)
end
function c240100223.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c240100223.activate(e,tp,eg,ep,ev,re,r,rp)
	local a=Duel.GetAttacker()
	local at=Duel.GetAttackTarget()
...
function c240100223.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c240100223.operation(e,tp,eg,ep,ev,re,r,rp)
