...
function c160008986.splimit(e,c,sump,sumtype,sumpos,targetp)
	if c:IsSetCard(0x885a) and c:IsType(TYPE_MONSTER)  then return false end
...
function c160008986.cfilter(c)
	return  c:IsSetCard(0x885a) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
...
function c160008986.adfilter(c)
	return c:IsType(TYPE_MONSTER)  and c:IsSetCard(0x885a) and c:IsType(TYPE_MONSTER) and not c:IsCode(160008986)  and c:IsAbleToHand()
end
...
function c160008986.xxlfilter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsSetCard(0x885a)  and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
