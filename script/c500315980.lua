...
function c500315980.thfilter(c)
	return c:IsLevelBelow(4) and c:IsSetCard(0x885a) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function c500315980.filter(c,e,tp)
	return c:IsSetCard(0x885a) and c:IsType(TYPE_MONSTER) and not c:IsCode(500315980) and not c:IsCode(160008986)  and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
