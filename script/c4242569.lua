...
c:SetUniqueOnField(1,0,4242569)
	...
	e1:SetCountLimit(1,4242569+EFFECT_COUNT_CODE_DUEL)
...
--end battle phase
	...
	e2:SetCountLimit(1,42425691+EFFECT_COUNT_CODE_DUEL)
	e2:SetCondition(c4242569.condition)
	e2:SetCost(c4242569.cost)
	...
	e3:SetTarget(c4242569.antarget)
	c:RegisterEffect(e3)
...
function c4242569.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c4242569.antarget(e,c)
	return c~=e:GetHandler()
end
function c4242569.unval(e,te)
