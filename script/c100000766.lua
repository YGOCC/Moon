...
c:EnableUnsummonable()
	...
	e2:SetTarget(c100000766.splimit)
	c:RegisterEffect(e2)
	--special summon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(100000766,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_QUICK_F)
	e1:SetRange(LOCATION_DECK)
	e1:SetCode(EVENT_CHAINING)
	e1:SetCondition(c100000766.spcon)
	e1:SetTarget(c100000766.sptg)
	e1:SetOperation(c100000766.spop)
	e1:SetCountLimit(1,100000766)	
	c:RegisterEffect(e1)
		--cannot release
