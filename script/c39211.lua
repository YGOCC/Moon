...
function scard.atkcon(e,tp,eg,ep,ev,re,r,rp)
	...
	e:SetLabelObject(c)
	return c and c:IsSetCard(0x43) and c:IsRelateToBattle()
end
function scard.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToGraveAsCost() end
	Duel.SendtoGrave(e:GetHandler(),REASON_COST)
end
function scard.atkop(e,tp,eg,ep,ev,re,r,rp,chk)
...
function scard.spfilter(c,e,tp)
	return (c:IsSetCard(0x43) or c:IsSetCard(0xa3)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
