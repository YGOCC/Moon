...
return  c:IsSetCard(0x85a) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_RITUAL,tp,false,true)
end
...
function c50031481.cgfilter(c)
	return c:GetLevel()>0 and  c:IsSetCard(0x185a) and c:IsReleasable()
end
...
return c:GetLevel()<=lv and c:IsType(TYPE_RITUAL) and c:IsSetCard(0x185a)
...
function c50031481.rfilter(c)
	return c:IsSetCard(0x185a) and not c:IsCode(50031481) and c:IsSummonable(true,nil)
end
