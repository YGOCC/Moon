...
function c500319545.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>3
		and Duel.IsPlayerCanSpecialSummonMonster(tp,57139546,0,0x4011,-2,4,nil,RACE_AQUA,ATTRIBUTE_LIGHT) end
...
function c500319545.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not  Duel.IsPlayerCanSpecialSummonMonster(tp,500319546,0,0x4011,-2,4,nil,RACE_AQUA,ATTRIBUTE_LIGHT) then return end
	for i=1,2 do
