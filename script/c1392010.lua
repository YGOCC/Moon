...
function c1392010.initial_effect(c)
	...
	e2:SetCondition(c1392010.indcon)
    e2:SetOperation(c1392010.indop)
	c:RegisterEffect(e2)
end
...
function c1392010.indcon(e,tp,eg,ep,ev,re,r,rp)
    return r==REASON_SYNCHRO
end
function c1392010.indop(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    local rc=c:GetReasonCard()
    local e1=Effect.CreateEffect(c)
    e1:SetDescription(aux.Stringid(1392010,1))
