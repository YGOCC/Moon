...
function c90000097.initial_effect(c)
	...
	e1:SetCondition(c90000097.condition1)
	...
	e2:SetCondition(c90000097.condition2)
	e2:SetCost(c90000097.cost2)
	e2:SetOperation(c90000097.operation2)
	c:RegisterEffect(e2)
end
function c90000097.filter1(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x5d) and c:IsControler(tp)
end
function c90000097.condition1(e,tp,eg,ep,ev,re,r,rp)
	if ep==tp or not re:IsHasProperty(EFFECT_FLAG_CARD_TARGET) then return false end
	local g=Duel.GetChainInfo(ev,CHAININFO_TARGET_CARDS)
	return g and g:IsExists(c90000097.filter1,1,nil,tp) and Duel.IsChainNegatable(ev)
end
...
function c90000097.condition2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()>=PHASE_BATTLE_START and Duel.GetCurrentPhase()<=PHASE_BATTLE
end
function c90000097.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c90000097.operation2(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c90000097.tg1)
	e1:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e1,tp)
end
function c90000097.tg1(e,c)
