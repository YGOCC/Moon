...
function c32083018.nfilter(c)
	return c:IsSetCard(0x7D53) and c:IsAbleToRemoveAsCost()
end
function c32083018.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c32083018.nfilter,tp,LOCATION_HAND,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c32083018.nfilter,tp,LOCATION_HAND,0,1,1,nil)
