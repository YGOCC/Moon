...
function c88880044.initial_effect(c)
	...
	e2:SetCost(c88880044.discost)
	e2:SetOperation(c88880044.disop2)
	c:RegisterEffect(e2)
end
--(1)
function c88880044.discon(e,tp,eg,ep,ev,re,r,rp)
	return not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED) and Duel.IsChainNegatable(ev) and e:GetHandler():IsSetCard(0x889) and not e:GetHandler():GetCode()
end
function c88880044.discost(e,tp,eg,ep,ev,re,r,rp,chk)
