...
function c69005.initial_effect(c)
	...
	function
c69005.reccon(e,tp,eg,ep,ev,re,r,rp)
return Duel.GetTurnPlayer()==tp
end
function
c69005.reccost(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    function
    c69005.rectg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    function
    c69005.recop(e,tp,eg,ep,ev,re,r,rp)
 ...
 function c69005.spcon(e,c)
	...
	return ft>-1 and Duel.IsExistingMatchingCard(c69005.spfilter,tp,LOCATION_ONFIELD,0,1,nil,ft)
end
function c69005.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_ONFIELD)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	local g=Duel.SelectMatchingCard(tp,c69005.spfilter,tp,LOCATION_ONFIELD,0,1,1,nil,ft)
