...
function c88880017.filter1(c,e,tp)
    ...
    return rk>0 and c:IsFaceup() and c:IsSetCard(0x107b) and (rk>0 or c:IsStatus(STATUS_NO_LEVEL)) and Duel.GetLocationCountFromEx(tp,tp,c)>0 
        and (Duel.IsExistingMatchingCard(c88880017.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,rk+1) or
        Duel.IsExistingMatchingCard(c88880017.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,rk+2) or
        Duel.IsExistingMatchingCard(c88880017.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,rk+3) or
        Duel.IsExistingMatchingCard(c88880017.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,rk+4) or
        Duel.IsExistingMatchingCard(c88880017.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,rk+5))
end
...
function c88880017.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
    ...
    if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1
        and Duel.IsExistingTarget(c88880017.filter1,tp,LOCATION_MZONE,0,1,nil,e,tp) end
...
function c88880017.activate(e,tp,eg,ep,ev,re,r,rp)
    ...
    local g=Duel.SelectMatchingCard(tp,c88880017.filter2,tp,LOCATION_EXTRA,0,1,1,nil,e,tp,tc,tc:GetRank()+lv)
    local sc=g:GetFirst()
    if sc then
...
function c88880017.efcon(e,tp,eg,ep,ev,re,r,rp)
    return Duel.IsExistingMatchingCard(c88880017.filter5,tp,LOCATION_GRAVE,0,2,nil)
end
function c88880017.eftarg(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return Duel.IsExistingMatchingCard(c88880017.filter6,tp,LOCATION_DECK,0,1,nil) and Duel.IsExistingMatchingCard(c88880017.filter5,tp,LOCATION_GRAVE,0,2,nil) end
...
function c88880017.efop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local h=Duel.SelectMatchingCard(tp,c88880017.filter5,tp,LOCATION_GRAVE,0,2,2,nil)
