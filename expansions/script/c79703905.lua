...
function c79703905.hdcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local ct=Duel.RemoveCounter(tp,1,1,0x1019,3,REASON_COST,1-tp)
	if ct>0 then Duel.RaiseEvent(e:GetHandler(),EVENT_REMOVE_COUNTER+0x1019,e,REASON_COST,tp,tp,ct) end
end
