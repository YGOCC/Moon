...
function cod.filter(c,e,tp,m1,m2,ft)
	if not c:IsCode(52894691) or not c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_RITUAL,tp,false,true) then return false end
