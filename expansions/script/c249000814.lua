...
function c249000814.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:CheckWithSumGreater(c249000814.getlevelorrank,lvrk*2,1,99,e:GetHandler()) and lvrk >=4 and lvrk <=9
		...
		local sg=g:SelectWithSumGreater(tp,c249000814.getlevelorrank,lvrk*2,1,99,e:GetHandler())
