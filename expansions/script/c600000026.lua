...
function c600000026.initial_effect(c)
	...
	e9:SetCondition(c600000026.rdcon)
	e9:SetOperation(c600000026.rdop)
	c:RegisterEffect(e9)
end
...
function c600000026.rdcon(e,tp,eg,ep,ev,re,r,rp)
	return ep~=tp
end
function c600000026.rdop(e,tp,eg,ep,ev,re,r,rp)
