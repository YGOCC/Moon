...
function cid.ffilter(c,fc,sub,mg,sg)
	return c:IsFusionSetCard(0xa88) and (not sg or not sg:IsExists(Card.IsFusionAttribute,1,c,c:GetFusionAttribute()))
end
function cid.sucop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetValue(c:GetMaterial():FilterCount(Card.IsSetCard,nil,0xa88)*300)
