...
function card.initial_effect(c)
  ...
  e3:SetDescription(aux.Stringid(88881011,0))
  ...
  e4:SetDescription(aux.Stringid(88881011,1))
...
function card.atkop(e,tp,eg,ep,ev,re,r,rp)
  ...
  local tc=sg:GetSum(Card.GetLevel)*150 or sg:GetSum(Card.GetRank)*150
