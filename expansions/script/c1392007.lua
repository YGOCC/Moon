...
function c1392007.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>=2 then
		...
		while tc do
			...
			local e7=e2:Clone()
			e7:SetCode(EFFECT_CANNOT_BE_POLARITY_MATERIAL)
			tc:RegisterEffect(e7)
			local e9=e2:Clone()
			e9:SetCode(EFFECT_CANNOT_BE_EVOLUTE_MATERIAL)
			tc:RegisterEffect(e9)
			local e10=e2:Clone()
			e10:SetCode(EFFECT_CANNOT_BE_BIGBANG_MATERIAL)
			tc:RegisterEffect(e10)
			local e11=e2:Clone()
			e11:SetCode(EFFECT_CANNOT_BE_TIMELEAP_MATERIAL)
			tc:RegisterEffect(e11)
			local e12=e2:Clone()
			e12:SetCode(EFFECT_CANNOT_BE_SPACE_MATERIAL)
