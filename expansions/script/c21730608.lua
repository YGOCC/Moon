--Ausica, Strata Savior
--By Auramram
local s,id=GetID()
function s.initial_effect(c)
	--link procedure
	aux.AddLinkProcedure(c,nil,2,nil,s.link_check)
	c:EnableReviveLimit()
	--search
...
function s.link_check(g,lc,tp)
	return g:GetClassCount(Card.GetLinkRace)==g:GetCount() or g:GetClassCount(Card.GetLinkAttribute)==g:GetCount()
end
--search
