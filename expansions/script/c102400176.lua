--created & coded by Lyris, art by sheisahumanparadox on Tumblr
--ニュートリックス・ブルーミー
local cid,id=GetID()
...
function cid.filter(c,e,tp)
	return c:IsSetCard(0xd10) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id)
end
