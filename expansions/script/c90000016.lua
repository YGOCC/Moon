...
function c90000016.initial_effect(c)
	...
	e2:SetCondition(c90000016.condition)
	e2:SetOperation(c90000016.operation)
	c:RegisterEffect(e2)
	--ATK Up
	...
	e3:SetOperation(c90000016.operation2)
	c:RegisterEffect(e3)
end
function c90000016.condition(e,tp,eg,ep,ev,re,r,rp)
