...
function c12000205.sumcon1(e,tp,eg,ep,ev,re,r,rp)
	return (not Duel.IsExistingMatchingCard(c12000205.cfilter1,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil)
		and Duel.IsExistingMatchingCard(c12000205.cfilter2,tp,LOCATION_MZONE,0,1,nil))
		and not Duel.IsExistingMatchingCard(c12000205.cfilter3,tp,LOCATION_ONFIELD,0,1,nil)
end
function c12000205.sumcon2(e,tp,eg,ep,ev,re,r,rp)
	return (not Duel.IsExistingMatchingCard(c12000205.cfilter1,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil)
		and Duel.IsExistingMatchingCard(c12000205.cfilter2,tp,LOCATION_MZONE,0,1,nil))
		and Duel.IsExistingMatchingCard(c12000205.cfilter3,tp,LOCATION_ONFIELD,0,1,nil)
end
...
function c12000205.excfilter(c)
	return not c:IsCode(12000206)
end
function c12000205.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	local exclude=Duel.GetMatchingGroup(c12000205.excfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil)
