--VECTOR Legion Naval Control
--Scripted by Zerry
function c67864665.initial_effect(c)
	--fusion material
...
function c67864665.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>(e:GetHandler():IsLocation(LOCATION_SZONE) and 0 or 1)
		and Duel.IsExistingTarget(c67864665.eqfilter,tp,LOCATION_GRAVE,0,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
	local g=Duel.SelectTarget(tp,c67864665.eqfilter,tp,LOCATION_GRAVE,0,1,1,nil,tp)
	Duel.SetOperationInfo(0,CATEGORY_LEAVE_GRAVE,g,1,0,0)
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,g,1,0,0)
end
function c67864665.operation(e,tp,eg,ep,ev,re,r,rp)
...
function c67864665.ntg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c67864665.nop(e,tp,eg,ep,ev,re,r,rp)
