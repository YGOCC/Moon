...
function c76565328.initial_effect(c)
	...
	e4:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x7555))
	e4:SetValue(c76565328.atkval)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
...
--stats boost
function c76565328.atkval(e,c)
	return e:GetHandler():GetCounter(0x1555)*50
end