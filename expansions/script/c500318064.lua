...
function c500318064.initial_effect(c)
	...
	e0:SetValue(c500318064.splimit)
	c:RegisterEffect(e0)
...
function c500318064.filter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x885a) and not c:IsCode(500318064) and c:IsAbleToDeck()
end
