...
function c88880013.initial_effect(c)
  ...
  e2:SetCondition(c88880013.indescon)
  e2:SetValue(1)
  c:RegisterEffect(e2)
  ...
  e3:SetCost(c88880013.atkcost)
  e3:SetTarget(c88880013.atktg)
  e3:SetOperation(c88880013.atkop)
  e3:SetCountLimit(1)
  c:RegisterEffect(e3)
  ...
  e4:SetTarget(c88880013.damtg)
  e4:SetOperation(c88880013.damop)
  c:RegisterEffect(e4)
...
--(2) This card cannot be destroyed in battle while it has material.
function c88880013.indescon(e,tp,eg,ep,ev,re,r,rp)
  return e:GetHandler():GetOverlayCount()>0
end
--(3) Once per turn, you can detach 1 material: banish 1 monster your opponent controls for each card in your Pendulum Zone, then, gain ATK equal to half the banished monster(s) combined ATK.
function c88880013.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) end
	e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
end
function c88880013.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_REMOVE,nil,1,1-tp,LOCATION_MZONE)
end
function c88880013.atkop(e,tp,eg,ep,ev,re,r,rp)
...
--(4) When this card destroys a monster by battle: deal damage equal to the destroyed monsters ATK.
function c88880013.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
  if chk==0 then return true end
...
function c88880013.damop(e,tp,eg,ep,ev,re,r,rp)
