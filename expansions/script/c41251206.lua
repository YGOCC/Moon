...
function cid.dcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,cid.cfilter1,1,nil) end
	Duel.Release(Duel.SelectReleaseGroup(tp,cid.cfilter1,1,1,nil),REASON_COST)
end
