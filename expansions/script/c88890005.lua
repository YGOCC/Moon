...
function c88890005.initial_effect(c)
    ...
    e5:SetDescription(aux.Stringid(88890005,1))
    e5:SetCategory(CATEGORY_RECOVER)
    e5:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
    e5:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
    e5:SetRange(LOCATION_MZONE)
    e5:SetCode(EVENT_BATTLE_DAMAGE)
    e5:SetCondition(c88890005.reccon)
    e5:SetTarget(c88890005.rectg)
    e5:SetOperation(c88890005.recop)
    c:RegisterEffect(e5)
    --(6) Negate
    local e6=Effect.CreateEffect(c)
    e6:SetDescription(aux.Stringid(88890005,2))
    ...
    e6:SetCountLimit(2)
    e6:SetCondition(c88890005.negcon)
    e6:SetTarget(c88890005.negtg)
    e6:SetOperation(c88890005.negop)
    c:RegisterEffect(e6)
    --(7) Place in S/T Zone
    local e7=Effect.CreateEffect(c)
    e7:SetDescription(aux.Stringid(88890005,3))
    e7:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
    e7:SetCode(EVENT_LEAVE_FIELD)
    e7:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
    e7:SetCondition(c88890005.stzcon)
    e7:SetTarget(c88890005.stztg)
    e7:SetOperation(c88890005.stzop)
    c:RegisterEffect(e7)
    --(8) Can't normal summon any monster
    ...
    --e8:SetCondition(c88890005.efcon)
    --e8:SetValue(c88890005.efval)
    --C:RegisterEffect(e8)
end
--Ritual Condition
