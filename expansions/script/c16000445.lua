...
function c16000445.cfilter(c)
	return c:IsSetCard(0x885a) and c:IsType(TYPE_MONSTER)and c:IsLocation(LOCATION_GRAVE)
end
...
function c16000445.cfilter(c)
	return c:IsSetCard(0x885a) and c:IsType(TYPE_MONSTER)  and c:IsAbleToRemoveAsCost()
end
