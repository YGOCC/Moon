...
function c21730409.initial_effect(c)
	...
	e1:SetCost(c21730409.thcost)
	e1:SetTarget(c21730409.thtg)
	e1:SetOperation(c21730409.thop)
	c:RegisterEffect(e1)
end
--return entire field to hand
function c21730409.thfilter(c)
	return c:IsSetCard(0x719) and c:IsDiscardable()
end
function c21730409.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c21730409.thfilter,tp,LOCATION_HAND,0,1,nil,e:GetHandler()) end
	Duel.DiscardHand(tp,c21730409.thfilter,1,1,REASON_COST+REASON_DISCARD,nil)
end
function c21730409.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c21730409.thop(e,tp,eg,ep,ev,re,r,rp)
