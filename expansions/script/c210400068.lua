...
function cid.val(e,c)
	return Duel.GetMatchingGroupCount(cid.atkfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,nil)*200
end
function cid.filter(c)
	return c:IsAttackPos() and c:IsCanChangePosition()
end
function cid.efcon(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,cid.filter,tp,0,LOCATION_MZONE,1,1,nil,POS_ATTACK)
