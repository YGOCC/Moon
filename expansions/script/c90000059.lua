...
function c90000059.initial_effect(c)
	...
	e2:SetCountLimit(1,90000059)
	e2:SetCondition(c90000059.condition2)
	...
	e3:SetTarget(c90000059.target3)
	e3:SetOperation(c90000059.operation3)
	c:RegisterEffect(e3)
end
function c90000059.condition2(e,tp,eg,ep,ev,re,r,rp)
...
function c90000059.target3(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_TOKEN,nil,1,0,0)
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,0,0)
end
function c90000059.operation3(e,tp,eg,ep,ev,re,r,rp)
