...
function c50031001.spfilter(c,ft)
...
function c50031001.hspcon(e,c)
	...
	return ft>-1 and Duel.IsExistingMatchingCard(c50031001.spfilter,tp,LOCATION_MZONE,0,1,nil,ft)
end
function c50031001.hspop(e,tp,eg,ep,ev,re,r,rp)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_MATERIAL)
	local g=Duel.SelectMatchingCard(tp,c50031001.spfilter,tp,LOCATION_MZONE,0,1,1,nil,ft)
