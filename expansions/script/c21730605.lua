...
function s.token_tg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,21730600,0x195,0x4011,1200,1200,3,RACE_WARRIOR,ATTRIBUTE_DARK) end
...
function s.token_op(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,21730600,0x195,0x4011,1200,1200,3,RACE_WARRIOR,ATTRIBUTE_DARK) then
