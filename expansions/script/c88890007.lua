...
function c88890007.atkval(e,c)
	return Duel.GetMatchingGroupCount(c88890007.atkfilter,c:GetControler(),LOCATION_SZONE,0,nil)*100 and Duel.GetMatchingGroupCount(c88890007.atkfilter,c:GetControler(),LOCATION_GRAVE,0,nil)*100
end
--(3) Pay or Destroy
