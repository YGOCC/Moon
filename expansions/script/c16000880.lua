...
function c16000880.mtcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return  ec:GetMaterial():IsExists(c16000880.ffilter,1,nil) and  r==REASON_EVOLUTE ~=0
end
function c16000880.mtop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(tp,16000880)~=0 then return end
   ...
   e1:SetDescription(aux.Stringid(16000880,0))
	...
	rc:RegisterFlagEffect(16000880,RESET_EVENT+RESETS_STANDARD+0x47e0000,0,1)
	end
	rc:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(16000880,0))
