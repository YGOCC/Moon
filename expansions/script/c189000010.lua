...
function cid.initial_effect(c)
	...
	e0:SetCondition(function(e,c) if c==nil then return true end return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(aux.AND(Card.IsFaceup,Card.IsCode),tp,LOCATION_ONFIELD,0,1,nil,id-9,id-10) end)
	c:RegisterEffect(e0)
...
function cid.filter(c)
	...
	return c:IsFaceup() and c:IsCode(id-9,id-10) and ct2==0
end
