...
function cid.activate(e,tp,eg,ep,ev,re,r,rp)
    ...
    local g=Duel.SelectMatchingCard(tp,cid.spfilter,tp,LOCATION_GRAVE+LOCATION_REMOVED,LOCATION_REMOVED,1,1,nil,e,tp)
    if Duel.Damage(tp,500,REASON_EFFECT)~=0 and g:GetCount()>0 then
