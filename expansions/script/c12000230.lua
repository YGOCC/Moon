...
function c12000230.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(12000230,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND)
	e1:SetCondition(c12000230.spcon)
	e1:SetTarget(c12000230.sptg)
	e1:SetOperation(c12000230.spop)
	c:RegisterEffect(e1)
	--draw
...
function c12000230.spcon(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(c12000230.cfilter,tp,LOCATION_MZONE,0,1,nil)
end
function c12000230.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,e:GetHandler(),1,0,0)
end
function c12000230.spop(e,tp,eg,ep,ev,re,r,rp)
