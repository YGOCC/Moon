...
local e1=Effect.CreateEffect(c)
	...
	e1:SetTarget(c67864672.sptg)
	e1:SetOperation(c67864672.spop)
	c:RegisterEffect(e1)
--Equip on Summon
...
function c67864672.tgfilter(c,e,tp,chk)
	return c:IsSetCard(0x52a6)
		...
		and (chk or Duel.IsExistingMatchingCard(c67864672.cfilter,tp,LOCATION_DECK,0,1,nil,c))
end
