--Ancient Engraved Array - Diquis
--Script by XGlitchy30
function c36541452.initial_effect(c)
	--synchro summon
	...
	e0:SetValue(c36541452.valcheck)
	c:RegisterEffect(e0)
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(36541452,0))
	e1:SetCategory(CATEGORY_EQUIP)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e1:SetProperty(EFFECT_FLAG_DELAY)
	e1:SetCode(EVENT_SPSUMMON_SUCCESS)
	e1:SetLabelObject(e0)
	e1:SetCondition(c36541452.eqcon)
	e1:SetTarget(c36541452.eqtg)
	e1:SetOperation(c36541452.eqop)
	c:RegisterEffect(e1)
	--attribute
	...
	e2:SetCondition(c36541452.attgain1)
	e2:SetValue(ATTRIBUTE_LIGHT)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	e3:SetCondition(c36541452.attgain2)
	e3:SetValue(ATTRIBUTE_DARK)
	c:RegisterEffect(e3)
	local e4=e2:Clone()
	e4:SetCondition(c36541452.attgain3)
	e4:SetValue(ATTRIBUTE_WATER)
	c:RegisterEffect(e4)
	local e5=e2:Clone()
	e5:SetCondition(c36541452.attgain4)
	e5:SetValue(ATTRIBUTE_FIRE)
	c:RegisterEffect(e5)
	local e6=e2:Clone()
	e6:SetCondition(c36541452.attgain5)
	e6:SetValue(ATTRIBUTE_EARTH)
	c:RegisterEffect(e6)
	local e7=e2:Clone()
	e7:SetCondition(c36541452.attgain6)
	e7:SetValue(ATTRIBUTE_WIND)
	c:RegisterEffect(e7)
	local e8=e2:Clone()
	e8:SetCondition(c36541452.attgain7)
	...
	e9:SetCondition(c36541452.attcon1)
	e9:SetValue(c36541452.efilter1)
	c:RegisterEffect(e9)
	local e11=e9:Clone()
	e11:SetCondition(c36541452.attcon2)
	e11:SetValue(c36541452.efilter2)
	c:RegisterEffect(e11)
	local e12=e9:Clone()
	e12:SetCondition(c36541452.attcon3)
	e12:SetValue(c36541452.efilter3)
	c:RegisterEffect(e12)
	local e13=e9:Clone()
	e13:SetCondition(c36541452.attcon4)
	e13:SetValue(c36541452.efilter4)
	c:RegisterEffect(e13)
	local e14=e9:Clone()
	e14:SetCondition(c36541452.attcon5)
	e14:SetValue(c36541452.efilter5)
	c:RegisterEffect(e14)
	local e15=e9:Clone()
	e15:SetCondition(c36541452.attcon6)
	e15:SetValue(c36541452.efilter6)
	c:RegisterEffect(e15)
	local e16=e9:Clone()
	e16:SetCondition(c36541452.attcon7)
	e16:SetValue(c36541452.efilter7)
	...
	e17:SetValue(c36541452.trap_immunity)
	c:RegisterEffect(e17)
	--spsummon (SYNCHRO)
	local e10=Effect.CreateEffect(c)
	e10:SetDescription(aux.Stringid(36541452,1))
	e10:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e10:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e10:SetProperty(EFFECT_FLAG_DELAY)
	e10:SetCode(EVENT_TO_DECK)
	e10:SetTarget(c36541452.sptg)
	e10:SetOperation(c36541452.spop)
	c:RegisterEffect(e10)
end
--filters
function c36541452.spfilter(c,e,tp)
	return c:IsCode(36541451) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
--attribute condition
function c36541452.attcon1(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_LIGHT)
end
function c36541452.attcon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_DARK)
end
function c36541452.attcon3(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_WATER)
end
function c36541452.attcon4(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_FIRE)
end
function c36541452.attcon5(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_EARTH)
end
function c36541452.attcon6(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_WIND)
end
function c36541452.attcon7(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_DIVINE)
end
--material check
function c36541452.valcheck(e,c)
...
--equip
function c36541452.eqcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_SYNCHRO)
end
function c36541452.eqtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c36541452.eqop(e,tp,eg,ep,ev,re,r,rp)
	local equip=e:GetLabelObject():GetLabelObject()
...
function c36541452.eqlimit(e,c)
	return e:GetOwner()==c
end
--attribute gain	
function c36541452.attgain1(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local eq=c:GetEquipGroup()
	return eq:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_LIGHT)
end
function c36541452.attgain2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local eq=c:GetEquipGroup()
	return eq:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_DARK)
end
function c36541452.attgain3(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local eq=c:GetEquipGroup()
	return eq:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_WATER)
end
function c36541452.attgain4(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local eq=c:GetEquipGroup()
	return eq:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_FIRE)
end
function c36541452.attgain5(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local eq=c:GetEquipGroup()
	return eq:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_EARTH)
end
function c36541452.attgain6(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local eq=c:GetEquipGroup()
	return eq:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_WIND)
end
function c36541452.attgain7(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local eq=c:GetEquipGroup()
	return eq:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_DIVINE)
end
--immunity value	
function c36541452.trap_immunity(e,te)
	return te:IsActiveType(TYPE_TRAP) and te:GetOwnerPlayer()~=e:GetHandlerPlayer()
end	
function c36541452.efilter1(e,te)
...
function c36541452.efilter2(e,te)
...
function c36541452.efilter3(e,te)
...
function c36541452.efilter4(e,te)
...
function c36541452.efilter5(e,te)
...
function c36541452.efilter6(e,te)
...
function c36541452.efilter7(e,te)
...
--spsummon
function c36541452.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c36541452.spfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_EXTRA)
end
function c36541452.spop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectMatchingCard(tp,c36541452.spfilter,tp,LOCATION_EXTRA,0,1,1,nil,e,tp)
	local tc=g:GetFirst()
	if tc then
