...
function cid.sfilter(c)
	return c:IsSetCard(0x777) and c:IsAbleToHand() and not c:IsCode(id)
end
...
function cid.atktg(e,c)
	return c~=e:GetHandler() and c:IsSetCard(0x777)
end
