...
function c50031002.initial_effect(c)
	...
	c:EnableReviveLimit()
 aux.AddEvoluteProc(c,nil,5,c50031002.filter1,c50031002.filter2)  
...
--spsummon proc
	...
	e2:SetDescription(aux.Stringid(50031002,0))
	e2:SetCategory(CATEGORY_SEARCH+CATEGORY_TOHAND)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetCondition(c50031002.retcon)
	e2:SetTarget(c50031002.rettg)
	e2:SetOperation(c50031002.retop)
	c:RegisterEffect(e2)
end
