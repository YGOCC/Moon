...
function c240100218.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return eg:FilterCount(Card.IsType,nil,TYPE_MONSTER)==1 and c240100218.cfilter(tc)
end
...
function c240100218.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c240100218.filter2,tp,LOCATION_DECK,0,1,eg:GetFirst():GetLevel(),nil)
