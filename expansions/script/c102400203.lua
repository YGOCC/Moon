...
function cid.spfilter(c,e,tp,tg)
	return (c:IsSetCard(0x70b) or not c:IsType(TYPE_EFFECT)) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_FUSION,tp,false,false) and Duel.GetLocationCountFromEx(tp,tp,tg)>0
end
