...
function cid.initial_effect(c)
	...
	aux.AddFusionProcFunRep2(c,id,aux.FilterBoolFunction(Card.IsType,TYPE_PANDEMONIUM),2,63,true,true)
	aux.AddContactFusionProcedure(c,Card.IsAbleToGraveAsCost,LOCATION_MZONE,0,function(c) return function(g) Duel.SendtoGrave(g,REASON_COST) end end)
	...
	e7:SetCondition(function(e,tp,eg,ep,ev,re,r,rp) return r&REASON_EFFECT~=0 end)
