...
function c210310309.initial_effect(c)
	--Activate
	...
	e1:SetCountLimit(1)
	e1:SetCondition(c210310309.condition)
	e1:SetTarget(c210310309.target)
	e1:SetOperation(c210310309.operation)
	c:RegisterEffect(e1)
	--special summon
	...
	e2:SetCountLimit(1,210310309+EFFECT_COUNT_CODE_OATH)
	e2:SetRange(LOCATION_SZONE)
	e2:SetCost(c210310309.cost)
	e2:SetTarget(c210310309.target1)
	e2:SetOperation(c210310309.operation1)
	c:RegisterEffect(e2)
	
end
--recover
function c210310309.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c210310309.target1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c210310309.filter,tp,LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil,e,tp) end
