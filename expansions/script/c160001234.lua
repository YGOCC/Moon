	...
	return c:IsSetCard(0x185a) or ( c:IsSetCard(0x85a) and c:IsType(TYPE_SPELL+TYPE_RITUAL))  and c:IsDiscardable()
end
...
if chk==0 then return Duel.IsExistingMatchingCard(c160001234.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_GRAVE)
end
function c160001234.thfilter(c)
...
Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c160001234.thfilter,tp,LOCATION_GRAVE,0,1,1,nil)
