--Code for some anime only xyz summon mechanics use with xpcall(function() require("expansions/script/c115000000") end,function() require("script/c115000000") end)
