...
local id,cod=23251001,c23251001
...
function cod.filter(c,e,tp)
	return c:IsAttackBelow(2000) and c:IsSetCard(0xd3e) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE,tp)
end
