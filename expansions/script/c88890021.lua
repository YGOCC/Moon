...
function c88890021.initial_effect(c)
    ...
    e4:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_SINGLE_RANGE+EFFECT_FLAG_CANNOT_NEGATE)
    ...
    e7:SetCondition(c88890021.stzcon)
    e7:SetOperation(c88890021.stzop)
    c:RegisterEffect(e7)
    --(6) Not Xyz Monster
    ...
    e11:SetType(EFFECT_TYPE_CONTINUOUS)
