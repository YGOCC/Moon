...
function c249000629.initial_effect(c)
	...
	e1:SetCondition(c249000629.condition)
	e1:SetCost(c249000629.cost)
	e1:SetTarget(c249000629.target)
	e1:SetOperation(c249000629.activate)
	c:RegisterEffect(e1)
end
function c249000629.condition(e,tp,eg,ep,ev,re,r,rp,chk)
	return tp==Duel.GetTurnPlayer() and (Duel.GetCurrentPhase()==PHASE_MAIN1 or Duel.GetCurrentPhase()==PHASE_MAIN2)
end
