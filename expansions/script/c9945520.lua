...
function c9945520.filter(c,e,tp,eg,ep,ev,re,r,rp)
...
function c9945520.acop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local tc=Duel.SelectMatchingCard(tp,c9945520.filter,tp,LOCATION_HAND+LOCATION_SZONE,0,1,1,nil):GetFirst()
