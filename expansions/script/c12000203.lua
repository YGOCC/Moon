...
function c12000203.sumcon1(e,tp,eg,ep,ev,re,r,rp)
	return (not Duel.IsExistingMatchingCard(c12000203.cfilter1,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil)
		...
		and not Duel.IsExistingMatchingCard(c12000203.cfilter3,tp,LOCATION_ONFIELD,0,1,nil)
end
function c12000203.sumcon2(e,tp,eg,ep,ev,re,r,rp)
	return (not Duel.IsExistingMatchingCard(c12000203.cfilter1,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil)
		and Duel.IsExistingMatchingCard(c12000203.cfilter2,tp,LOCATION_MZONE,0,1,nil))
		and Duel.IsExistingMatchingCard(c12000203.cfilter3,tp,LOCATION_ONFIELD,0,1,nil)
end
