...
function cid.initial_effect(c)
	...
	e1:SetCondition(function(e,tp) return Duel.IsExistingMatchingCard(aux,AND(Card.IsFaceup,Card.IsSetCard),tp,LOCATION_ONFIELD,0,1,nil,0x88a) end)
	...
	e2:SetCondition(function(e) return Duel.GetMatchingGroup(aux.AND(Card.IsFaceup,Card.IsSetCard),e:GetHandler():GetControler(),LOCATION_MZONE,0,nil,0x88a):GetClassCount(Card.GetAttribute)>2 end)
	c:RegisterEffect(e2)
end
