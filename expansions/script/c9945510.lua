...
function c9945510.filter(c,e,tp,eg,ep,ev,re,r,rp)
...
function c9945510.acop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,c9945510.filter,tp,LOCATION_HAND+LOCATION_SZONE,0,1,1,nil):GetFirst()
