...
function cid.initial_effect(c)
	...
	exx:SetType(EFFECT_TYPE_FIELD)
	exx:SetCode(EFFECT_SPSUMMON_PROC)
	exx:SetProperty(EFFECT_FLAG_UNCOPYABLE)
	exx:SetRange(LOCATION_EXTRA)
	exx:SetCondition(cid.spcon2)
	exx:SetOperation(cid.spop3)
