...
function c53313916.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--M-When exactly 1 face-up "Mysterious" or LIGHT Dragon monster you control is destroyed by battle or an opponent's card effect, and no other cards: You can Tribute 2 monsters; Special Summon this card from your hand or face-up from your Extra Deck, and if you do, this card gains that monster's effects (if any), until the end of the turn. (HOPT2)
...
function c53313916.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
