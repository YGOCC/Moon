...
function cid.atkfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xead) and c:IsType(TYPE_MONSTER)
end
function cid.repfilter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0xead) and c:IsLocation(LOCATION_MZONE)
