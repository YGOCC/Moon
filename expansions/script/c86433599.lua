...
function c86433599.matfilter(c)
	return c:IsLinkSetCard(0x86f) and c:IsPosition(POS_FACEUP_DEFENSE)
end
...
function c86433599.thop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local extra=TYPE_FUSION+TYPE_SYNCHRO+TYPE_XYZ+TYPE_LINK+TYPE_EVOLUTE
