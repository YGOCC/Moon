...
function c19772599.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddFusionProcFunRep(c,c19772599.matfilter,3,true)
	--spsummon condition
...
function c19772599.spfilter1(c,tp,g)
	return g:IsExists(c19772599.spfilter2,2,c,tp,c)
end
...
function c19772599.spop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
	local g2=g:FilterSelect(tp,c19772599.spfilter2,2,2,mc,tp,mc)
	g1:Merge(g2)
	c:SetMaterial(g1)
