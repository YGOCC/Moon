...
function cid.ritualsearchfilter(c)
    return (bit.band(c:GetType(),0x82)==0x82 or bit.band(c:GetType(),0x81)==0x81) and c:IsAbleToHand() and c:IsSetCard(0x666)
end
