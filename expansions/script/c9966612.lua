--Oscurità Irregolare - Werwolf Freiwilliger
...
function cid.tgfilter(c,tp,mode)
	...
	if mode==0 then
		return c:IsSetCard(0x4999) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave() and Duel.IsExistingMatchingCard(cid.tgfilter,tp,LOCATION_DECK,0,1,c,tp,1)
	else
