...
function c160002424.pmfilter(c)
	return c:IsLevelBelow(4) and c:IsSetCard(0x185a) and  c:IsType(TYPE_MONSTER) and not c:IsCode(160003232)
end
...
function c160002424.cfilter(c)
	return c:IsSetCard(0x185a) and c:IsType(TYPE_MONSTER) and c:IsDiscardable()
end
