...
if TYPE_CUSTOM&TYPE_DECKMASTER==0 then TYPE_CUSTOM=TYPE_CUSTOM+TYPE_DECKMASTER end
CTYPE_DECKMASTER					=0x400
if CTYPE_CUSTOM&CTYPE_DECKMASTER==0 then CTYPE_CUSTOM=CTYPE_CUSTOM+CTYPE_DECKMASTER end
...
--overwrite constants
if TYPE_EXTRA&TYPE_DECKMASTER==0 then TYPE_EXTRA=TYPE_EXTRA+TYPE_DECKMASTER end
