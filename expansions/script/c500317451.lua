...
function c500317451.filter(c)
	return (c:IsSetCard(0x885a) and c:IsType(TYPE_SPELL+TYPE_TRAP)) or (c:IsSetCard(0x47) or c:IsSetCard(0x46) or c:IsCode(24094653)) and c:IsAbleToHand()
end
