...
function c160002213.exfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x285a) and c:IsAbleToHand()
end
...
function c160002213.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and c:IsFaceup() then
		Duel.SendtoHand(g,nil,REASON_EFFECT)
		Duel.ConfirmCards(1-tp,g)
	end
end
function c160002213.spfilter(c,e,tp)
	return c:IsSetCard(0x285a) and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
