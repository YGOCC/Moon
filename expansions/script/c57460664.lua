--Alza-Rango-Magico - Il Puntodifuoco
...
function cid.filter1(c,e,tp)
	local rk=c:GetRank()
	return c:IsFaceup() and c:IsType(TYPE_XYZ) and c:IsSetCard(0xb05)
...
function cid.filter2(c,e,tp,mc,rk)
	return c:IsRank(rk) and c:IsSetCard(0xb05) and mc:IsCanBeXyzMaterial(c)
