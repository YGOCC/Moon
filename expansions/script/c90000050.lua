...
function c90000050.filter1_1(c,e,tp)
	return c:IsSetCard(0x1c) and c:IsLevelAbove(1)
...
function c90000050.filter2_1(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x1c) and c:IsLevelAbove(1)
		and Duel.IsExistingMatchingCard(c90000050.filter2_2,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil,c:GetLevel(),e,tp)
end
...
function c90000050.operation2(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
		local g=Duel.SelectMatchingCard(tp,c90000050.filter2_2,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,1,nil,tc:GetLevel(),e,tp)
		local sc=g:GetFirst()
		if sc then
