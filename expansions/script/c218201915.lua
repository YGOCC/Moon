...
function cid.initial_effect(c)
	...
	e2:SetValue(aux.TargetBoolFunction(Card.IsSetCard,0x88f))
	c:RegisterEffect(e2)
	...
	e4:SetValue(function(e,c) return e:GetHandler():GetEquipTarget():GetBattleTarget():GetBaseAttack() end)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
