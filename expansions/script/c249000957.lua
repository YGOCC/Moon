...
function c249000957.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(70089580,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
	e2:SetCountLimit(1,249000957)
	e2:SetCondition(c249000957.condition)
	e2:SetTarget(c249000957.target)
	e2:SetOperation(c249000957.operation)
	c:RegisterEffect(e2)
end
