...
function c249000559.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(249000559,0))
	...
	e2:SetCondition(c249000559.sprcon)
	e2:SetOperation(c249000559.sprop)
	c:RegisterEffect(e2)
	--copy
	...
	e3:SetDescription(aux.Stringid(249000559,1))
	e3:SetTarget(c249000559.target)
	e3:SetOperation(c249000559.operation)
	c:RegisterEffect(e3)
	--spsummon
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(249000559,2))
