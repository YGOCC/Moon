...
function c240100175.initial_effect(c)
	...
	e3:SetCountLimit(1,240100175)
	e3:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e3:SetDescription(1108)
	e3:SetCondition(c240100175.mcon(c240100175.drcon))
	e3:SetTarget(c240100175.drtg)
	e3:SetOperation(c240100175.drop)
	c:RegisterEffect(e3)
	local o3=e3:Clone()
	o3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	o3:SetProperty(EFFECT_FLAG_PLAYER_TARGET+EFFECT_FLAG_DELAY)
	o3:SetCondition(c240100175.ocon(c240100175.drcon))
	c:RegisterEffect(o3)
end
...
function c240100175.drcon(e)
	return e:GetHandler():GetSummonType()==SUMMON_TYPE_SPECIAL+1
end
function c240100175.drtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:IsHasType(EFFECT_TYPE_TRIGGER_F) or Duel.IsPlayerCanDraw(tp,1) end
	Duel.SetTargetPlayer(tp)
	Duel.SetTargetParam(1)
	Duel.SetOperationInfo(0,CATEGORY_DRAW,nil,0,tp,1)
end
function c240100175.drop(e,tp,eg,ep,ev,re,r,rp)
