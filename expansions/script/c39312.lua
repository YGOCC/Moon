...
function c39312.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)==0
		...
		Duel.RegisterEffect(tp,39312,RESET_PHASE+PHASE_END,0,1)
	end
end
...
function c39312.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c39312.filter,tp,LOCATION_MZONE,0,1,e:GetHandler()) end
