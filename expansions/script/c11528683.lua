...
function c11528683.thfilter(c)
	return c:IsSetCard(0x850) and not c:IsCode(11528683) and c:IsAbleToHand()
end
function c11528683.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c11528683.thfilter,tp,LOCATION_DECK,0,1,nil) end
