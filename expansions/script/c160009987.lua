...
function c160009987.initial_effect(c)
		aux.AddXyzProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0x285a),5,3,c160009987.ovfilter,aux.Stringid(160009987,0))
	c:EnableReviveLimit()
		--
...
function c160009987.ovfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x285a) and c:IsType(TYPE_XYZ) and c:GetRank()==4
end
