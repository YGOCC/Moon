...
function c210424260.postg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc~=c and chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1-tp) and c210424260.filter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c210424260.filter,tp,LOCATION_MZONE,0,1,e:GetHandler()) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_POSCHANGE)
	local g=Duel.SelectTarget(tp,c210424260.filter,tp,LOCATION_MZONE,0,1,1,e:GetHandler())
