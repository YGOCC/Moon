...
function cid.initial_effect(c)
	...
	ponyignition:SetTarget(cid.sptg)
	ponyignition:SetOperation(cid.spop)
...
function cid.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(cid.spfilter,tp,LOCATION_GRAVE,0,1,e:GetHandler(),e,tp) end
