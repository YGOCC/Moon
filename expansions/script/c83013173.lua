...
function cod.cfilter(c)
	return c:IsFaceup() and c:IsDestructable() and c:GetEquipTarget()
...
function cod.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g1=Duel.SelectTarget(tp,cod.cfilter,tp,LOCATION_SZONE,0,1,1,nil)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g2=Duel.SelectTarget(tp,cod.cfilter2,tp,0,LOCATION_SZONE,1,1,nil)
	g1:Merge(g2)
