...
function cid.initial_effect(c)
	...
	e5:SetCondition(function(e) local ec=e:GetHandler():GetEquipTarget() return ec and Duel.GetAttackTarget() and (ec==Duel.GetAttacker() or ec==Duel.GetAttackTarget()) end)
