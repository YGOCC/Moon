...
function c88880045.spfilter1(c,e,tp)
  return c:IsFaceup() and c:IsSetCard(0x1889) and c:IsType(TYPE_XYZ) and c:IsRank(12) and Duel.GetLocationCountFromEx(tp,tp,c)>0
...
function c88880045.spfilter2(c,e,tp,mc,rk)
  ...
  return c:GetRank()==rk and c:IsSetCard(0x1889) and mc:IsCanBeXyzMaterial(c)
