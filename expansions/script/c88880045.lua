...
function c35.initial_effect(c)
    ...
    e1:SetCondition(c35.rcon)
    e1:SetOperation(c35.rop)
    c:RegisterEffect(e1)
end
function c35.rcon(e,tp,eg,ep,ev,re,r,rp)
...
function c35.rop(e,tp,eg,ep,ev,re,r,rp)
