...
function c88880045.initial_effect(c)
	...
	--e2:SetTarget(c88880045.equtar)
	--e2:SetOperation(c88880045.equop)
	--c:RegisterEffect(e2)
	--(3) ATK gain
...
--(2) equip
--function c88880045.equtar(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
--	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsFaceup() end
--	if chk==0 then return GetMatchingGroup(Card.IsFaceup,tp,LOCATION_MZONE,0,nil,c:IsSetCard(0x896)) end
--	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
--	Duel.SelectTarget(tp,Card.IsFaceup,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil,c:IsSetCard(0x896))
--	Duel.SetOperationInfo(0,CATEGORY_EQUIP,e:GetHandler(),1,0,0)
--end
--function c88880045.equop(e,tp,eg,ep,ev,re,r,rp)
--	local tc=GetMatchingGroup(Card.IsFaceup,tp,LOCATION_MZONE,0,nil,c:IsSetCard(0x896))
...
--	return g:GetSum(Card.GetLevel)*300 and g:GetSum(Card.GetRank)*300
--end