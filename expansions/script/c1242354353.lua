...
function c1242354353.thop(e,tp,eg,ep,ev,re,r,rp)
 ...
 --ritual eff 
function c1242354353.filter(c,e,tp)
...
function c1242354353.ritual(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c1242354353.filter,tp,LOCATION_HAND,0,1,nil,e,tp) end
...
function c1242354353.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c1242354353.filter,tp,LOCATION_HAND,0,1,1,nil,e,tp)
	local tc=g:GetFirst()
	if tc then
