...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFieldGroupCount(Card.IsFacedown,tp,LOCATION_MZONE,1,nil) end
	local sg=Duel.GetFieldGroup(tp,Card.IsFacedown,tp,LOCATION_MZONE,nil)
