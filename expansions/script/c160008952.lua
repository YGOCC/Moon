...
function c160008952.filter(c,e,tp)
	return c:IsFaceup() and (c:IsSetCard(0xc50)  and c:IsType(TYPE_MONSTER)) or (c:IsType(TYPE_MONSTER) and not c:IsType(TYPE_EFFECT)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
