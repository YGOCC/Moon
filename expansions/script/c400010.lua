...
function c400010.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		if Duel.IsPlayerCanSpecialSummonMonster(tp,400009,0x146,0x4011,1700,1000,4,RACE_FAIRY,ATTRIBUTE_WATER)
		and Duel.IsExistingMatchingCard(function(c)return c:IsSetCard(0x146) and c:IsType(TYPE_QUICKPLAY) and c:GetCode()~=400013 end,tp,LOCATION_GRAVE,0,1,nil)
