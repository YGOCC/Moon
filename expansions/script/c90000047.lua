...
function c90000047.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c90000047.condition2)
	e2:SetCost(c90000047.cost2)
	e2:SetOperation(c90000047.operation2)
	c:RegisterEffect(e2)
	--Special Summon
	...
	e3:SetTarget(c90000047.target3)
...
function c90000047.condition2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp and Duel.GetCurrentPhase()>=PHASE_BATTLE_START and Duel.GetCurrentPhase()<=PHASE_BATTLE
end
function c90000047.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c90000047.operation2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c90000047.filter3(c,e,tp,rk)
	return c:GetRank()==rk+2 and c:IsSetCard(0x1c) and e:GetHandler():IsCanBeXyzMaterial(c)
		and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_XYZ,tp,false,false)
end
function c90000047.target3(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1
		and Duel.IsExistingMatchingCard(c90000047.filter3,tp,LOCATION_EXTRA,0,1,nil,e,tp,e:GetHandler():GetRank()) end
...
function c90000047.operation3(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c90000047.filter3,tp,LOCATION_EXTRA,0,1,1,nil,e,tp,c:GetRank())
	local sc=g:GetFirst()
	if sc then
