...
function c90000076.condition1(e,tp,eg,ep,ev,re,r,rp)
	return re:GetHandler()==e:GetHandler():GetEquipTarget()
end
function c90000076.operation1(e,tp,eg,ep,ev,re,r,rp)
	Duel.SetChainLimit(c90000076.limit1)
end
function c90000076.limit1(e,ep,tp)
	return ep==tp
end
...
function c90000076.operation2(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetValue(c90000076.val1)
	e1:SetReset(RESET_PHASE+PHASE_DAMAGE)
	Duel.RegisterEffect(e1,tp)
end
function c90000076.val1(e,re,tp)
