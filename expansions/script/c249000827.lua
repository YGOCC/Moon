...
function c249000827.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(82593786,0))
	e4:SetType(EFFECT_TYPE_QUICK_O)
	e4:SetCode(EVENT_FREE_CHAIN)
	e4:SetHintTiming(TIMING_BATTLE_PHASE)
	e4:SetRange(LOCATION_GRAVE)
	e4:SetCountLimit(1,82593786+EFFECT_COUNT_CODE_DUEL)
	e4:SetCondition(c249000827.condition)
...
function c249000827.condition(e,tp,eg,ep,ev,re,r,rp)
