--Oscurità Irregolare - Lepre Marzincubo
...
function cid.disfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x4999)
end
--stop attack
function cid.stopcon(e,tp,eg,ep,ev,re,r,rp)
	local d=Duel.GetAttackTarget()
	return d:IsFaceup() and d:IsSetCard(0x4999) and d:IsType(TYPE_MONSTER) and not e:GetHandler():IsStatus(STATUS_CHAINING)
end
