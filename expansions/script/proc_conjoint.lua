...
if TYPE_CUSTOM&TYPE_CONJOINT==0 then TYPE_CUSTOM=TYPE_CUSTOM+TYPE_CONJOINT end
CTYPE_CONJOINT						=0x40
if TYPE_CUSTOM&CTYPE_CONJOINT==0 then TYPE_CUSTOM=TYPE_CUSTOM+CTYPE_CONJOINT end
