...
function c249000554.initial_effect(c)
	...
	e1:SetOperation(c249000554.regop)
	c:RegisterEffect(e1)
end
function c249000554.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c249000554.thtg)
	e1:SetOperation(c249000554.thop)
...
function c249000554.thop(e,tp,eg,ep,ev,re,r,rp)
