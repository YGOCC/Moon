...
function c240100014.initial_effect(c)
	...
	e2:SetCondition(c240100014.descon)
	e2:SetOperation(c240100014.desop)
	c:RegisterEffect(e2)
	local e2=Effect.CreateEffect(c)
...
function c240100014.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.GetFieldGroupCount(tp,0,LOCATION_HAND)>0 end
	Duel.SetOperationInfo(0,CATEGORY_REMOVE,nil,1,0,LOCATION_HAND)
end
function c240100014.operation(e,tp,eg,ep,ev,re,r,rp)
