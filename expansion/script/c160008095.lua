...
function c160008095.filter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x885a) and not c:IsCode(160008095) and c:IsAbleToRemove()
end
...
function c160008095.spfilter(c,tp)
	return c:IsSetCard(0x85a) and c:IsType(TYPE_SPELL+TYPE_TRAP) and Duel.IsPlayerCanSpecialSummonMonster(tp,nil,nil,0x11,1850,0,4,RACE_AQUA,ATTRIBUTE_LIGHT)
end
