...
function c240100188.initial_effect(c)
	...
	e3:SetCondition(function(e,tp,eg,ep,ev,re,r,rp) local tc=eg:GetFirst() return eg:GetCount()==1 and tc:GetPosition()==POS_FACEUP_ATTACK and tc:GetPreviousPosition()>0x3 end)
