...
function c500316141.initial_effect(c)
	...
	e666:SetProperty(EFFECT_FLAG_SINGLE_RANGE)
	e666:SetRange(LOCATION_MZONE)
	e666:SetCode(EFFECT_IMMUNE_EFFECT)
	e666:SetValue(c500316141.efilter)
...
function c500316141.mat_filter(c)
	return c:IsLevelBelow(4) and not (c:IsCode(500316141) or  c:IsCode(160003232))
end
...
function c500316141.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=g:GetFirst()
	if tc:IsSetCard(0x185a) and tc:IsType(TYPE_MONSTER) then
