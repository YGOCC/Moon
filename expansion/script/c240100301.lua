...
function c240100301.spfilter(c,e,tp)
	return c:IsType(TYPE_XYZ) and c:GetOverlayGroup():IsExists(c240100301.filter,1,nil,e,tp)
end
...
function c240100301.tg2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c240100301.spfilter,tp,LOCATION_MZONE,0,1,nil,e,tp) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_OVERLAY)
end
function c240100301.op2(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0 then return end
	local g=Group.CreateGroup()
	local xg=Duel.GetMatchingGroup(c240100301.spfilter,tp,LOCATION_MZONE,0,nil,e,tp)
